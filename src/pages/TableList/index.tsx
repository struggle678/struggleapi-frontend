...
import {listInterfaceInfoByPageUsingGet} from "@/services/struggleapi-backend/interfaceInfoController";
...
const TableList: React.FC = () => {
  ...
  const columns: ProColumns<API.InterfaceInfo>[] = [
    ...
    {
      title: <FormattedMessage id="pages.searchTable.name" defaultMessage="接口名称" />,
      dataIndex: 'name',
      valueType: 'text',
    },
    {
    ...
    {
      title: <FormattedMessage id="pages.searchTable.method" defaultMessage="请求方法" />,
      dataIndex: 'method',
      valueType: 'text',
    },
    {
    ...
    {
      title: <FormattedMessage id="pages.searchTable.requestHeader" defaultMessage="请求头" />,
      dataIndex: 'requestHeader',
      valueType: 'textarea',
    },
    {
      title: <FormattedMessage id="pages.searchTable.responseHeader" defaultMessage="响应头" />,
